...
import { getFirestore, doc, setDoc, getDoc, collection } from "firebase/firestore"; // Import collection function
...
export { auth, db, storage, doc, setDoc, getDoc, collection, ref, uploadBytes, getDownloadURL };
